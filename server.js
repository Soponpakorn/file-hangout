...
var app = require('http').createServer( function(request, response) {
    ...
    response.write('<title>socketio-over-nodejs</title><h1><a href="'+ link + '">socketio-over-nodejs</a></h1><pre>var socket = io.connect("https://localhost:8080/");</pre>');
    response.end();
});
...
console.log('Please open SSL URL: https://localhost:'+(process.env.PORT || 8080)+'/');